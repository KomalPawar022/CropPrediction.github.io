					...
					<div class="col-md-8">
						<div class="card">
							<div class="card-header">
								...
								<h2 class="title">Select Crop Type</h2>
							</div>
							<div class="card-body">
								<form action="CropType.jsp" method="post">
									<div class="row">
										<div class="col-md-12">
                      ...
                      ArrayList<TypeBean> titlelist=dao.getCategory(crop);
                      
                      for(int i=0;i<titlelist.size();i++)
                      {
                      %>
                      
                      <option style="background-color: black" value="<%=titlelist.get(i).getType()%>"><%=titlelist.get(i).getType()%></option> 
