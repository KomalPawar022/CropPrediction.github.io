				...
				<div class="row">
					<div class="col-md-8">
						<div class="card">
							...
							<div class="card-body">
								<form action="CropTypeData.jsp" method="post">
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label>Select Crop</label> <select
													style="background-color: black" name="crop"
													class="form-control">
													<option>Select</option>
													<option>amudam</option>
													<option>banana</option>
													<option>bengalgram</option>
													<option>blackgram</option>
													<option>brinjal</option>
													
													<option>chilli</option>
													
													<option>dhaniyalu</option>
													<option>ginger</option>
													
													<option>grape</option>
													<option>greengram</option>
													<option>groundnut</option>
													
													<option>horsegram</option>
													...
													<option>ragi</option>
													<option>redgram</option>
													<option>rice</option>
													
													<option>sajja</option>
													
													<option>seasameoil</option>
